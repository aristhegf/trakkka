...
const PUBLIC_PATHS = ["/login", "/signup", "/forgot-password", "/auth", "/api/ingest", "/api/notify", "/api/health"];

/**
 * Refreshes the Supabase session cookie on every request and redirects
 * unauthenticated users away from the app. API routes authenticate themselves.
 */
