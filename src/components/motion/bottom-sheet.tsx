...
export interface BottomSheetProps {
  ...
  /** Trakkka: override the scrim, e.g. a light unblurred one so the map stays visible behind the sheet. */
        ...
        <PresenceGate key="backdrop">
          {({ gate }) => (
            <motion.button
              ...
              className={cn("pointer-events-auto fixed inset-0 z-50 bg-background/40 backdrop-blur-sm", backdropClassName)}
            />
          )}
        </PresenceGate>
      ) : null}
